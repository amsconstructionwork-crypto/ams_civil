...
export default function BreadcrumbNav() {
  ...
  return (
    <nav aria-label="Breadcrumb" className="absolute top-[112px] md:top-[120px] w-full z-30 py-3 px-4 bg-white/5 border-y border-white/10 overflow-x-auto whitespace-nowrap">
